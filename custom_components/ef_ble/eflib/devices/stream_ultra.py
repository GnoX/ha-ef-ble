...
class Device(stream_pro.Device, ProtobufProps):
    ...
    # Sniffer data
    backup_reverse_soc = pb_field(pb.backup_reverse_soc)
    bms_batt_heating = pb_field(pb.bms_batt_heating)
    bms_batt_soc = pb_field(pb.bms_batt_soc, lambda v: round(v, 2))
    ...
    bms_max_cell_temp = pb_field(pb.bms_max_cell_temp)
    ...
    cms_max_chg_soc = pb_field(pb.cms_max_chg_soc)
    cms_min_dsg_soc = pb_field(pb.cms_min_dsg_soc)
    ...
    feed_grid_mode_pow_limit = pb_field(pb.feed_grid_mode_pow_limit)
    feed_grid_mode_pow_max = pb_field(pb.feed_grid_mode_pow_max)
    grid_code_selection = pb_field(pb.grid_code_selection)
    grid_code_version = pb_field(pb.grid_code_version)
    grid_connection_freq = pb_field(pb.grid_connection_freq, lambda v: round(v, 2))
    grid_connection_power = pb_field(pb.grid_connection_power, lambda v: round(v, 2))
    grid_connection_sta = pb_field(pb.grid_connection_sta)
    grid_connection_vol = pb_field(pb.grid_connection_vol, lambda v: round(v, 2))
    ...
    plug_in_info_pv2_amp = pb_field(pb.plug_in_info_pv2_amp, lambda v: round(v, 2))
    plug_in_info_pv2_vol = pb_field(pb.plug_in_info_pv2_vol, lambda v: round(v, 2))
    plug_in_info_pv3_amp = pb_field(pb.plug_in_info_pv3_amp, lambda v: round(v, 2))
    plug_in_info_pv3_vol = pb_field(pb.plug_in_info_pv3_vol, lambda v: round(v, 2))
    plug_in_info_pv4_amp = pb_field(pb.plug_in_info_pv4_amp, lambda v: round(v, 2))
    plug_in_info_pv4_vol = pb_field(pb.plug_in_info_pv4_vol, lambda v: round(v, 2))
    plug_in_info_pv_amp = pb_field(pb.plug_in_info_pv_amp, lambda v: round(v, 2))
    plug_in_info_pv_vol = pb_field(pb.plug_in_info_pv_vol, lambda v: round(v, 2))
    ...
    pow_get_pv = pb_field(pb.pow_get_pv, lambda v: round(v, 2))
    pow_get_pv2 = pb_field(pb.pow_get_pv2, lambda v: round(v, 2))
    pow_get_pv3 = pb_field(pb.pow_get_pv3, lambda v: round(v, 2))
    pow_get_pv4 = pb_field(pb.pow_get_pv4, lambda v: round(v, 2))
    pow_get_pv_sum = pb_field(pb.pow_get_pv_sum, lambda v: round(v, 2))
