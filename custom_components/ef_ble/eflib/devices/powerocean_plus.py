from ._powerocean_base import PowerOceanBase, _MpptPv, WorkMode
...
class Device(PowerOceanBase):
    ...
    # String data (only Plus supporort 3rd string)
    pv_fault_code_1 = pb_field(pb_ems_state_change_report.mppt1_fault_code)  # mppt_pv1_fault_code
    pv_warning_code_1 = pb_field(pb_ems_state_change_report.mppt1_warning_code)  # mppt_pv1_warning_code
    ...
    #        po.pb_ems_change_report is similar than pb_ems_state_change_report (and not pb_ems_change_report as we would expect)
