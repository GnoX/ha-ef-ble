...
from ..devicebase import DeviceBase, PacketIterator
...
from ..util.batch_updater import DeviceUpdater, ThrottledBatchUpdater
...
class Device(DeviceBase, ProtobufProps):
    ...
    def __init__(
        ...
        self._updater = ThrottledBatchUpdater(
            self, [pb.cms_batt_soc, pb.flow_info_ac_out]
        )
