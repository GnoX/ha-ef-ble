        ...
        match packet.src, packet.cmdSet, packet.cmdId:
            ...
            case 0x60, 0x60, 0x11:  # 17
                if not self.isPowerOceanPlus():
                    ...
                    self.update_from_bytes(re307_sys_pb2.EmsChangeReport,
                                           packet.payload)  # andy - has some code see 8 too
            ...
            case _:
                self._logger.info("Unprocessed packet sss: src=%d,cmdSet=%d,cmdId=%d: Packet=%s", packet.src,
                                  packet.cmdSet, packet.cmdId, packet)
