...
class Connection:
    ...
    async def _clear_gatt_cache(self) -> None:
        ...
        # reconnect keeps resolving the same broken service table. `clear_cache` is
        # provided by Home Assistant's client wrapper and by
        # `BleakClientWithServiceCache`, plain `BleakClient` lacks it, hence `getattr`
